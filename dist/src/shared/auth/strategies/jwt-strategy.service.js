...
let JwtStrategyService = class JwtStrategyService extends passport_1.PassportStrategy(passport_jwt_1.Strategy) {
    constructor(authService, configurationService) {
        super({
            jwtFromRequest: passport_jwt_1.ExtractJwt.fromAuthHeaderAsBearerToken(),
            secretOrKey: configurationService.get(configuration_enum_1.Configuration.JWT_KEY),
        });
    ...
    validate(payload, done) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield this.authService.validatePayload(payload);
            if (!user) {
